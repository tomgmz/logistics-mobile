...
import { ArrowLeft, Send, CornerUpLeft, X, Users, Check, X as XIcon } from 'lucide-react-native'
  ...
  useMessagingRealtime({
    ...
    onGroupMessage: (raw) => {
      ...
      setMessages(prev => {
        ...
        if (raw.sender_id !== currentUserId) messagingApi.markGroupRead(groupId, [inc.id]).catch(() => {})
        return [...prev, inc]
      })
